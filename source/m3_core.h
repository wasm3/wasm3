...
static inline
bool IsSpelledRefType (m3type_t i_type)
{
    return (i_type & d_m3Type_ref) != 0;
}
static inline
bool IsNullableRef (m3type_t i_type)
{
    return (i_type & d_m3Type_refNonNull) == 0;
}
static inline
u32 HeapTypeOf (m3type_t i_type)
{
